...
//        }).start();
        ...
        Button mButton = (Button) findViewById(R.id.dummy_button);
        //点击按钮进入登入界面
...
//                        "com.example.administrator.eight.LoginActivity");
    ...
    private void hide() {
        ...
        mControlsView.setVisibility(View.GONE); //设置为隐藏
        mVisible = false;
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.administrator.eight/http/host/path")
        );
